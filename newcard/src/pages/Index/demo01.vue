    ...
    <div class="demo01">
            ...
            <div class="showElement">
                ...
                <div class="showElementCenter" :style="{'background': `url(${defultBackgroundPicture}) 0% 0% / 100% 100%  no-repeat ${defultBackgroundColor}`}">
                    ...
                    <div class="items" @click="selectElement(i,index)">
                        ...
                        <div class="name"  v-if="i.name !=='地址'&&i.name!=='电话'&&i.name !== '请添加新闻资讯'&&i.name==='图片'&&i.name !== '富文本'&&i.name !== '视频'&&i.name !=='文本'&&i.name !== '图文广告'&&i.name !== '营销活动'&&i.name!=='标题'&&i.name !== '空白辅助'" :style="{'backgroundColor':pictureStyles,'borderRadius':pictureSendPhoneRadius+'px','marginLeft':pictureSendPhoneMargin+'px','marginRight':pictureSendPhoneMargin+'px','paddingLeft':pictureSendPhonePadding+'px','paddingRight':pictureSendPhonePadding+'px',}"> 
                            <div style=" width: 100%;height:248px;text-align: center;"><img style="width: 100%; height: 100%; text-align: center; display: block; border-radius: 0px;" :src="pictureBackgroundImg" alt="" ></div>
                        </div>
                        <!-- 新闻资讯 -->
                    ...
                    <!-- <span class="delete" @click="delElement(i)">X</span> -->
                    <!-- <div style="float: right; width:20px" @click="delElement(i)">1
                        <div class="del"></div>
                    </div>  -->
                    </div>
                    </draggable> 
        ...
        <div class="right">
            ...
            <div>
                ...
                <!-- 图片 -->
                <pictureStyle v-if="pictureStyle" @getData="getData" @radius="radius" @margin='margin' @padding='padding' @pictureBackgroundPicture='pictureBackgroundPicture' />
                <!-- 新闻样式 -->
